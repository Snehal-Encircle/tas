...
function DestinationListing() {
    ...
    const handleGeneratePinStyle = (() => {
        if (window.innerWidth >= 1441 && window.innerWidth <= 1900) {
            setPinStyle([{
                title: "Uganda",
        ...
        if (window.innerWidth >= 1408 && window.innerWidth <= 1440) {
            setPinStyle([{
                title: "Uganda",
                image: "../images/UGorillas.png",
                position: {
        ...
        if (window.innerWidth >= 1346 && window.innerWidth <= 1407) {
            setPinStyle([{
                title: "Uganda",
                image: "../images/UGorillas.png",
                position: {
        ...
        if (window.innerWidth >= 1189 && window.innerWidth <= 1345) {
            setPinStyle([{
                title: "Uganda",
                image: "../images/UGorillas.png",
                position: {
        ...
        if (window.innerWidth >= 1024 && window.innerWidth <= 1189) {
            setPinStyle([{
                title: "Uganda",
                image: "../images/UGorillas.png",
                position: {
        ...
        if (window.innerWidth >= 360 && window.innerWidth <= 639) {
            setPinStyle([{
                title: "Uganda",
                image: "../images/UGorillas.png",
                position: {
    ...
    return (
        <React.Fragment>
            ...
            <section className='map-zigzag bg-pattern lg:py-40 py-30'>
                            ...
                            <div className='map-with-content relative lg:pl-100' id="image-map">
                                <div className='img relative'>
                                    <div className='' onMouseEnter={() => {
                                        ...
                                        <img src="../images/Africa-map.png" className='map-img lgscreen:m-auto lgscreen:mt-50' alt="Map" />
                                    </div>
                                    {pinStyle.map((item, i) => {
                                        return <div className='map-pin country1' data-xpos={pleft} data-ypos={ptop} style={{ left: item.position.left, right: item.position.right, top: item.position.top }}>
                                            {curentSlide === i && <div className='pin-tooltip-content bg-red-200 py-20 px-30'>
                                                <div className='bg-img absolute right-15 opacity-20'>
                                                    <img src={item.image} className="w-[88px]" alt="" />
                                                </div>
                                                <h6>{item.title}</h6>
                                                <div className='btn-custom flex flex-wrap items-start justify-start space-x-8 mt-10'>
                                                    <Link to="/" className='button btn-white-border'>Explore Destination</Link>
                                                </div>
                                            </div>}
                                            <div className=''>
                                                <div id={'tooltip' + i} onClick={(e) => { setCurentSlide(i) }} onMouseEnter={(e) => {
                                                    var elems = document.querySelectorAll(".pin-content");
                                                    [].forEach.call(elems, function (el) {
                                                        el.classList.remove("show");
                                                    });
                                                    var btnContainer = document.getElementById('tooltip' + i);
                                                    btnContainer.classList.add("show");
                                                    setCurentSlide(i)
                                                }} className='pin-content'>
                                                    <img src="../images/marker.png" className='xsscreen2:max-w-16 mdscreen:max-w-20 lgscreen:max-w-16 max-w-20' alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    })}
